...
export const STRINGS: StringTable = {
  ...
  // ── Movie detail page ──────────────────────────────────────────────────
  "movie.searching":        { zh: "正在翻找这部片…",    en: "Looking it up…" },
  "movie.networkError":     { zh: "网不太稳——再试一次", en: "Network hiccup. Try again." },
  "movie.notFound":         { zh: "没找到这部片——换英文名试试？", en: "Can't find this one — try the English title." },
  ...
  "pre.ratingsEmpty":       { zh: "新片上映没多久——评分还没凑齐", en: "Too fresh — ratings aren't in yet." },
  ...
  "pre.vocabHint":          { zh: "点一下看中文 · ▶ 听发音", en: "Tap for meaning · ▶ play audio" },
  "pre.breaks":             { zh: "厕所时间",          en: "Bathroom Breaks" },
  "pre.breaksHint":         { zh: "几个错过戏份最少的起身时机——按叙事节奏推算", en: "A few low-risk moments to slip out — paced to the story." },
  ...
  "pre.noHintInfo":         { zh: "这部片还没整理到提示", en: "No preview written yet." },
  "pre.directorNote":       { zh: "导演注解",          en: "Director's Note" },
  "pre.wikipedia":          { zh: "维基百科",          en: "Wikipedia" },
  "pre.showtimePrompt":     { zh: "告诉我你看的是几点场", en: "What time is your screening?" },
  "pre.showtimeHelper":     { zh: "填了之后，下方的起身时间会换算成你手表上的钟点", en: "Fill it in — break times below become wall-clock times." },
  "pre.showtimeEmpty":      { zh: "点这里选 →",        en: "Tap to pick →" },
  ...
  "pre.breakInfo":          { zh: "开场后 {m} 分 · 有 {d} 分钟窗口 · 错过风险 {r}", en: "{m}min in · {d}min window · miss risk {r}" },
  "pre.breakInfoNoStart":   { zh: "有 {d} 分钟窗口 · 错过风险 {r}", en: "{d}min window · miss risk {r}" },
  "pre.includeTrailers":    { zh: "把预告片时间算进去",  en: "Include trailers" },
  "pre.trailerPlus":        { zh: "+25 分钟",          en: "+25 min" },
  "pre.trailerSkip":        { zh: "不算",              en: "Skipped" },
  ...
  "pre.spoilerUnlock":      { zh: "▸ 看一眼第一幕（含微剧透）", en: "▸ Peek at Act I (light spoiler)" },
  "pre.spoilerLocked":      { zh: "里面有一点点氛围剧透，确定再点", en: "Small atmosphere spoiler inside — tap if you're OK with it." },
  "pre.cached":             { zh: "⚡ 已缓存",          en: "⚡ Cached" },
  "pre.aiGenerating":       { zh: "整理中…",           en: "Putting it together…" },
  "pre.aiAnalyzing":        { zh: "推算中…",           en: "Working it out…" },
  "pre.expandMore":         { zh: "还有 {n} 条，展开看", en: "{n} more below" },
  "pre.aiError":            { zh: "这段没跑出来——刷新一下再试", en: "That section didn't load — try refreshing." },
  "pre.factsError":         { zh: "花絮没拉到——刷新再试",   en: "Fun facts didn't load — refresh to retry." },
  "pre.vocabError":         { zh: "词汇没整理出来——刷新再试", en: "Vocab didn't load — refresh to retry." },
  "pre.breaksError":        { zh: "没推算出合适的起身时机——刷新再试", en: "Couldn't work out break timing — refresh to retry." },
  ...
  "post.lockHintLine1":     { zh: "下面全是剧透",       en: "Full spoilers below" },
  "post.lockHintLine2":     { zh: "剧情梳理 · 人物关系 · 彩蛋解析", en: "Plot · Characters · Easter Eggs" },
  "post.lockHintLine3":     { zh: "看完再点开，别破坏体验",  en: "Come back after you've seen it." },
  "post.unlockButton":      { zh: "看完了，打开复盘",   en: "I've seen it — open up" },
  "post.spoilerBar":        { zh: "下面全是剧透",       en: "Full spoilers below" },
  "post.generating":        { zh: "整理复盘中…",        en: "Putting the review together…" },
  "post.error":             { zh: "复盘没跑出来——刷新再试", en: "Review didn't load — refresh to retry." },
